...
public interface BusDelCustomerInfoService {
    ...
    */
    ...
    void downloadCreditFile(List<BusDelCustomerInfoDto> all, HttpServletRequest request, HttpServletResponse response) throws Exception;

   	void downloadCreditFile(List<BusDelCustomerInfoDto> all)throws Exception;
