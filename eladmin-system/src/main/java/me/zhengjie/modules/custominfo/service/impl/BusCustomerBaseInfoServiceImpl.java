...
public class BusCustomerBaseInfoServiceImpl implements BusCustomerBaseInfoService {
    ...
    public Map<String,Object> queryAll(BusCustomerBaseInfoQueryCriteria criteria, Pageable pageable){
        Page<BusCustomerBaseInfo> page = busCustomerBaseInfoRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root,criteria,criteriaBuilder),pageable);
    ...
    public List<BusCustomerBaseInfoDto> queryAll(BusCustomerBaseInfoQueryCriteria criteria){
        return busCustomerBaseInfoMapper.toDto(busCustomerBaseInfoRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root,criteria,criteriaBuilder)));
    }

    @Override
    @Transactional
    public BusCustomerBaseInfoDto findById(Long id) {
        BusCustomerBaseInfo busCustomerBaseInfo = busCustomerBaseInfoRepository.findById(id).orElseGet(BusCustomerBaseInfo::new);
    ...
    public void update(BusCustomerBaseInfo resources) {
        BusCustomerBaseInfo busCustomerBaseInfo = busCustomerBaseInfoRepository.findById(resources.getId()).orElseGet(BusCustomerBaseInfo::new);
    ...
    @Override
    public void downloadCreditFile(List<BusCustomerBaseInfoDto> all, HttpServletRequest request, HttpServletResponse response) {
        if (all == null) {
