...
@Entity
@Data
@Table(name="bus_inacctinf_guarmotgacltalctrctinfsgmt")
public class BusInacctinfGuarmotgacltalctrctinfsgmt implements Serializable {
    ...
    public void copy(BusInacctinfGuarmotgacltalctrctinfsgmt source){
