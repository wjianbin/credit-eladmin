...
@Entity
@Data
@Table(name="bus_inacctinf_rltrepymtinfsgmt")
public class BusInacctinfRltrepymtinfsgmt implements Serializable {
    ...
    public void copy(BusInacctinfRltrepymtinfsgmt source){
