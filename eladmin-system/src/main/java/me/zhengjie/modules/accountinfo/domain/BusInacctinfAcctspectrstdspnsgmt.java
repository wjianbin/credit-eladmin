...
@Entity
@Data
@Table(name="bus_inacctinf_acctspectrstdspnsgmt")
public class BusInacctinfAcctspectrstdspnsgmt implements Serializable {
    ...
    @Column(name = "CagOfTrdNm")
    @ApiModelProperty(value = "交易个数")
    ...
    public void copy(BusInacctinfAcctspectrstdspnsgmt source){
