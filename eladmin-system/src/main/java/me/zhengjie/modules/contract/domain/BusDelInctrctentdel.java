...
@Entity
@Data
@Table(name="bus_del_inctrctentdel")
public class BusDelInctrctentdel implements Serializable {
    ...
    public void copy(BusDelInctrctentdel source){
