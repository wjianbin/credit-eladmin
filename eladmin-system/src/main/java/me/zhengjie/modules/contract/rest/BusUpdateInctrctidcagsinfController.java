...
public class BusUpdateInctrctidcagsinfController {
    ...
    public void download(HttpServletRequest request,HttpServletResponse response, BusUpdateInctrctidcagsinfQueryCriteria criteria) throws Exception {
        //busUpdateInctrctidcagsinfService.download(busUpdateInctrctidcagsinfService.queryAll(criteria), response);
        busUpdateInctrctidcagsinfService.downloadCreditFile(busUpdateInctrctidcagsinfService.queryAll(criteria),request,response);
    }
