...
* @date 2020-07-01
**/
public interface BusInctrctinfCreditlimsgmtService {
    ...
    */
    Map<String,Object> queryAll(BusInctrctinfCreditlimsgmtQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<BusInctrctinfCreditlimsgmtDto>
    */
    List<BusInctrctinfCreditlimsgmtDto> queryAll(BusInctrctinfCreditlimsgmtQueryCriteria criteria);

    /**
     * 根据ID查询
     * @param id ID
     * @return BusInctrctinfCreditlimsgmtDto
     */
    BusInctrctinfCreditlimsgmtDto findById(Long id);
    ...
    * @return BusInctrctinfCreditlimsgmtDto
    */
    BusInctrctinfCreditlimsgmtDto create(BusInctrctinfCreditlimsgmt resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(BusInctrctinfCreditlimsgmt resources);
