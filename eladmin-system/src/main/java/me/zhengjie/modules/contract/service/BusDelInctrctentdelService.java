...
* @date 2020-07-01
**/
public interface BusDelInctrctentdelService {
    ...
    */
    Map<String,Object> queryAll(BusDelInctrctentdelQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<BusDelInctrctentdelDto>
    */
    List<BusDelInctrctentdelDto> queryAll(BusDelInctrctentdelQueryCriteria criteria);

    /**
     * 根据ID查询
     * @param id ID
     * @return BusDelInctrctentdelDto
     */
    BusDelInctrctentdelDto findById(Long id);
    ...
    * @return BusDelInctrctentdelDto
    */
    BusDelInctrctentdelDto create(BusDelInctrctentdel resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(BusDelInctrctentdel resources);
