...
public class BusInctrctinfCtrctcertrelServiceImpl implements BusInctrctinfCtrctcertrelService {
    ...
    @Override
    public void downloadCreditFile(List<BusInctrctinfCtrctcertrelDto> all, HttpServletRequest request, HttpServletResponse response) throws Exception {

    }

    @Override
    public void downloadCreditFile(List<BusInctrctinfCtrctcertrelDto> all) throws Exception {
